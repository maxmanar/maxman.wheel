...
واجهة عربية متجاوبة تجمع عرض اليوم الوطني ٩٦ من Canva مع عجلة اختيار المشاركين وأسئلة الوطن، جاهزة للاستضافة على Vercel.
...
- عرض Canva المرسل داخل قسم متجاوب أعلى المسابقة، بنسبة ١٦:٩، مع خيار الإخفاء والإظهار، ودعم ملء الشاشة، ورابط لفتح العرض في صفحة مستقلة.
- مقدمة وخطوات مرتبة من مشاهدة العرض إلى تجهيز المشاركين وبدء التحدي، مع رابط مباشر إلى ساحة المسابقة.
...
افتح `http://localhost:8000` في المتصفح. ملفات العجلة والأسئلة والخطوط محلية، ويحتاج عرض Canva المضمّن إلى اتصال بالإنترنت وإتاحة رابط العرض للمشاهدة.
